...
import { ProButton, openDialog, renderDialogForm, uiMessage } from '@snowbitx/ui-element'
import Case from '../components/Case.vue'
import ElementUserForm from '../components/ElementUserForm.vue'
import { tableFormItems, tableRules } from '../datasource'

defineOptions({
  name: 'ElementDialogPage',
})
...
<template>
  <h1>@snowbitx/ui-element 命令式弹窗</h1>
